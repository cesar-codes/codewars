...
const findDeletedNumber = (arr, mixArr) => arr.length === mixArr.length ? 0 : mixArr.reduce((a,b) => a - b, 0) - arr.reduce((a,b) => a - b, 0)
...
//     return arr.length === mixArr.length ? 0 :  mixArr.reduce((a,b) => a - b, 0) - arr.reduce((a,b) => a - b, 0)
// }
